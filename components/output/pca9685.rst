...
- **channel** (**Required**, int): Choose the number of channels for the PCA9685. Must be in range from 0 to 15.
- **pca9685_id** (*Optional*, :ref:`config-id`): Manually specify the ID of the
  :ref:`PCA9685 hub <pca9685-component>`.
  Use this if you have multiple PCA9685s that you would like to use at the same time.
